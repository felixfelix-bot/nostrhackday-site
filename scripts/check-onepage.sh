...
for s in 'September 29th, 2026' '>Tuesday<' '29.09.2026' 'Two days before bitcoin++' 'https://btcpp.dev/' 'https://btcpp.dev/berlin26' 'https://x.com/CashuBTC/status/2099845950768324657' 'Ecash Hackday' 'target-strip' 'Mine your RSVP' 'SIGN UP'; do
